...
print('Найденные параметры модели: {:.4f} {:.4f}'.format(
    theta[0, 0], theta[1, 0]))
...
print('Для численности населения 35,000 предсказанная прибыль = ${:.4f}'.format(
    predict1[0, 0] * 10000))
print('Для численности населения 70,000 предсказанная прибыль = ${:.4f}'.format(
    predict2[0, 0] * 10000))
